...
![Тренды по тематикам]({{ "assets/images/posts/foresight/1.png" | relative_url }}){:class="img-responsive center-align"}
...
![Предложенные проекты по аспектам использования пространственных данных]({{ "assets/images/posts/foresight/2.png" | relative_url }}){:class="img-responsive center-align"}

![Предложенные проекты по тематикам]({{ "assets/images/posts/foresight/3.png" | relative_url }}){:class="img-responsive center-align"}
...
![Итоговые проекты форсайт-сессии]({{ "assets/images/posts/foresight/4.png" | relative_url }}){:class="img-responsive center-align"}
